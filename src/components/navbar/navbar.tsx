            ...
            <header className="sticky top-0 backdrop-blur-xl py-2 z-50">
                <nav className="px-4 md:px-0 py-2 max-w-2xl mx-auto flex justify-between items-center">
                    ...
                    <div className="flex gap-4">
                        ...
                        {
                            theme === "dark" ? <Button onClick={() => setTheme("light")} variant="outline" size="icon" className="cursor-pointer">
                                <Moon className="fill-white" />
                            </Button> : <div>
                                <Button onClick={() => setTheme("dark")} variant="outline" size="icon" className="cursor-pointer">
