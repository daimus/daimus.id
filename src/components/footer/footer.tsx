export default function Footer (){
    return (
        <>
            <footer className="border-t mt-14 border-zinc-200 dark:border-zinc-700">
                ...
                <div className='flex flex-col items-center mt-14 mb-14'>
                    ...
                    <a className="group flex items-center text-xl font-medium text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500"
                       href="mailto:mail@daimus.id">
                        <svg viewBox="0 0 24 24" aria-hidden="true"
                             className="h-7 w-7 flex-none fill-zinc-500 transition group-hover:fill-emerald-500">
                        ...
                        <span className="ml-2">mail@daimus.id</span>
                    </a>

                    <div className="mt-6 flex gap-6">
                        <a className="group -m-1 p-1" aria-label="Follow on Instagram"
                           href="https://www.instagram.com/daimus.suudi">
                            <svg viewBox="0 0 24 24" aria-hidden="true"
                        ...
                        <a className="group -m-1 p-1" aria-label="Follow on GitHub" href="https://github.com/daimus">
                            <svg viewBox="0 0 24 24" aria-hidden="true"
                                 className="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
                        ...
                        <a className="group -m-1 p-1" aria-label="Follow on LinkedIn"
                           href="https://www.linkedin.com/in/daimus">
                            <svg viewBox="0 0 24 24" aria-hidden="true"
                                 className="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
                                <path
